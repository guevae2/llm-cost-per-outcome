...
export default function About() {
  return (
    <div className="max-w-4xl mx-auto w-full px-4 sm:px-6 py-12 flex-1 flex flex-col">
      ...
      <main className="space-y-10 text-slate-300 leading-relaxed text-sm">
        <section className="bg-panelBg/20 border border-slate-800/80 p-5 rounded-2xl flex items-center justify-between">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="text-xs bg-emerald-950 text-emerald-400 hover:bg-emerald-900 border border-emerald-800/60 px-4 py-2 rounded-xl font-bold transition duration-200"
          >
            Visit AgentNoah
          </a>
        </section>
        ...
        <section className="space-y-4">
          <h2 className="text-xl font-bold text-white flex items-center gap-2">
            <Scale className="h-5 w-5 text-accentTeal" />
          ...
          <div className="bg-slate-900/60 border border-slate-800 p-5 rounded-xl space-y-2">
            ...
            <div className="p-3 bg-black/40 rounded font-mono text-emerald-400 text-xs text-center">
        ...
        <section className="space-y-4">
          <h2 className="text-xl font-bold text-white flex items-center gap-2">
            <BookOpen className="h-5 w-5 text-accentTeal" />
            <span>Proven Data & Source URLs</span>
          </h2>
          
          <div className="bg-slate-900/40 border border-slate-800/80 rounded-xl overflow-hidden text-xs">
        ...
        <section className="space-y-4">
          <h2 className="text-xl font-bold text-white flex items-center gap-2">
            <FileSpreadsheet className="h-5 w-5 text-accentTeal" />
          ...
          <div className="pt-4 text-center">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 text-xs text-accentTeal hover:underline font-semibold"
            >
      ...
      <footer className="mt-auto border-t border-slate-900 pt-8 text-center text-xs text-slate-500">
